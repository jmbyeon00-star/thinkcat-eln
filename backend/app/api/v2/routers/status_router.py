...
async def update_status(run_type: str, user_id: str, body: dict, session: Session = Depends(get_sync_session)):
...
async def update_progress(run_type: str, target_id: str, body: dict, session: Session = Depends(get_sync_session)):
