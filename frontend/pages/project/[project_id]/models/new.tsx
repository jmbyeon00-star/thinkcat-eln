// frontend/pages/project/models/new.tsx
...
export default function ProjectTrainPage() {
    ...
    useEffect(() => {
        ...
        async function loadProjectDataGroup() {
            try {
                ...
                setTrainingConfig({ modelName: 'BERT-Patent-v1', epoch: 10, batchSize: 32, learningRate: 1e-5, maxLength: 256, shuffle: true });
    ...
    // const handleTrainingDataUpdate = useCallback((updaterOrNewItems) => {
    ...
    //     // onTrainingDataSelect의 사용 방식을 통일해야 합니다.

    // }, []);

    const handleTrainingDataUpdate = useCallback(
        (
            updaterOrNewItems:
                | any[]
                | ((prev: any[]) => any[])
    ...
    // const handleCounterDataUpdate = useCallback((updaterOrNewItems) => {
    //     if (typeof updaterOrNewItems === 'function') {
    //         setCounterDataItems(updaterOrNewItems);
    //     }
    //     else if (Array.isArray(updaterOrNewItems)) {
    //         setCounterDataItems(prev => [...prev, ...updaterOrNewItems]);
    //     }
    // }, []);

    const handleCounterDataUpdate = useCallback(
        (
            updaterOrNewItems:
                | any[]
                | ((prev: any[]) => any[])
