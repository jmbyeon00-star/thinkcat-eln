                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-zinc-700 mb-3 flex items-center gap-2">
                                    <div className="w-1 h-4 bg-gradient-to-b from-cyan-600 to-blue-600 rounded-full" />
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-white border-2 border-zinc-200 rounded-xl 
                                        focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100
                                        ...
                                        <label
                                            ...
                                            className={`
                                                ...
                                                ${taskType === option.value
                                                    ...
                                                    : 'border-zinc-200 bg-white hover:border-cyan-300 hover:shadow-sm'
                                                }
                            ...
                            {/* Info Box */}
                            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-100 rounded-xl p-4">
                            ...
                            <div className="flex items-center justify-between pt-4">
                                ...
                                <button
                                    ...
                                    className="px-8 py-3 text-base font-bold text-white bg-gradient-to-r from-cyan-600 to-blue-600 
