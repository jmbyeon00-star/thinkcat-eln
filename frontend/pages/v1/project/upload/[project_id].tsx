...
import ProjectLayout from "@/components/v1/layouts/ProjectLayout";
...
function ProjectUploadPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      router.push(`/v1/project/preview/${project_id}`);
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-5xl mx-auto p-8 space-y-8">
          ...
          <div className="flex justify-between items-center">
            {/* 왼쪽: 이전으로 */}
            <button
              onClick={() => router.push("/v1/project/new")}
            ...
            {/* 오른쪽: 다음으로 */}
            <button
              onClick={() => router.push(`/v1/project/preview/${project?.id}`)}
