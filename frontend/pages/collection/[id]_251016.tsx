    ...
    return (
        <div className="space-y-4 border p-4 rounded-lg bg-zinc-50">
            ...
            {inferenceResults.length > 0 && (
                <>
                    <h3 className="text-lg font-semibold mt-6 mb-2">📊 추천 결과</h3>
            ...
            {histories.length > 0 && (
                <>
                    <h3 className="text-lg font-semibold mt-6 mb-2">📈 학습 히스토리</h3>
                    <table className="w-full border text-sm">
                        <thead>
                            <tr className="bg-zinc-100">
                                <th>Epoch</th>
                        ...
                        <tbody>
                            {histories.map((h, i) => (
                                <tr key={i} className="border-t">
                                    ...
                                    <td>{h.valid_loss.toFixed(4)}</td>
                                    <td>{(h.train_acc * 100).toFixed(1)}%</td>
                                    <td>{(h.valid_acc * 100).toFixed(1)}%</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
