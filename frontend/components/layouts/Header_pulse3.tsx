                            ...
                            <>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        {isBusy && (
                                            <>
                                                <span className="absolute -inset-2 rounded-full bg-purple-600 opacity-75 animate-ping" />
                                                <span className="absolute -inset-1 rounded-full border-2 border-indigo-600 animate-pulse" />
                                            </>
                                        )}
                                        {/* 프로필 이미지 */}
                                        <img
