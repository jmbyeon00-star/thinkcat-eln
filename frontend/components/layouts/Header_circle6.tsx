                            ...
                            <>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        {isBusy && (
                                            <span
                                                className="absolute -inset-2 rounded-full border-[6px] border-t-white border-r-gray-200 border-b-white border-l-gray-200 animate-spin"
                                                style={{
                                                    filter: 'drop-shadow(0 0 12px rgba(255, 255, 255, 1)) drop-shadow(0 0 20px rgba(255, 255, 255, 0.8))'
                                                }}
                                            />
                                        )}
                                        {/* 프로필 이미지 */}
                                        <img
                                            ...
                                            alt="Profile"
                                            className="relative z-10 w-full h-full object-cover rounded-full bg-white"
                                        />
                                    </button>
