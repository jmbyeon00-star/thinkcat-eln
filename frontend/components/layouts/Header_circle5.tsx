                            ...
                            <>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        {/* 회전하는 외부 테두리만 */}
                                        {isBusy && (
                                            <span className="absolute -inset-1 rounded-full border-3 border-transparent bg-gradient-to-r from-purple-600 to-indigo-600 animate-spin shadow-lg shadow-purple-500/50" />
                                        )}
                                        {/* 프로필 이미지 */}
                                        <img
