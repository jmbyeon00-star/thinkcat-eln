...
export default function AboutPage() {
    return (
      ...
      `}</style>
            ...
            {/* SECTION 5: 가치 제안 (Agent About에서 가져옴) */}
                ...
                <div className="max-w-6xl mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-8 bg-white border border-zinc-100 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all group">
                            ...
                            <p className="text-zinc-400 text-sm leading-relaxed font-medium">전국 특허 사무소의 실제 출원 및 등록 실적을 기술 분야별(CPC)로 정밀하게 분석하여 객관적인 지표를 제공합니다.</p>
                        </div>
                        <div className="p-8 bg-white border border-zinc-100 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all group">
                            <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                <Shield className="text-blue-600" size={24} />
                            </div>
                            <h4 className="text-xl font-bold mb-3">검증된 전문가 그룹</h4>
                            <p className="text-zinc-400 text-sm leading-relaxed font-medium">경력, 전문 분야, 주요 실적이 검증된 변리사 정보를 투명하게 공개하여 사용자가 직접 신뢰를 판단할 수 있습니다.</p>
                        </div>
                        <div className="p-8 bg-white border border-zinc-100 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all group">
                            <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <p className="text-zinc-400 text-sm leading-relaxed font-medium">사용자의 기술 키워드와 가장 유사한 특허 실적을 보유한 사무소를 Milvus 엔진을 통해 정확하게 찾아냅니다.</p>
                        </div>
                    </div>
                </div>
            </section>

            {/* SECTION 6: 전문가 매칭 CTA (Agent About에서 가져옴) */}
            <section className="px-6 bg-white">
                <div className="max-w-6xl mx-auto w-full">
