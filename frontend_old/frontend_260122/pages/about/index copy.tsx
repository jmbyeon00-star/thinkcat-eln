...
export default function AboutPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-zinc-50 to-white text-zinc-800">
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          <p className="text-lg text-zinc-600 leading-relaxed mb-12">
            IPFORCE는 특허 데이터에 특화된 인공지능 플랫폼으로,
          ...
          <div className="border-t border-zinc-200 pt-10 mb-16">
            <h2 className="text-2xl font-semibold mb-4 text-zinc-900">시스템 아키텍처</h2>
            <p className="text-zinc-600 mb-6">
              IPFORCE는 <b>Frontend (Next.js)</b> · <b>Backend (FastAPI)</b> · <b>GPU Backend (PyTorch)</b>
              3계층 구조로 구성되어 있습니다. 모든 학습·추론 작업은 GPU 백엔드에서 실행되며,
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6 border rounded-lg bg-white shadow-sm hover:shadow-md transition">
                <h3 className="text-lg font-semibold text-emerald-700 mb-2">Frontend</h3>
                <p className="text-sm text-zinc-600">Next.js + Tailwind 기반의 인터랙티브 웹 UI</p>
              </div>
              <div className="p-6 border rounded-lg bg-white shadow-sm hover:shadow-md transition">
                <h3 className="text-lg font-semibold text-emerald-700 mb-2">Backend</h3>
                <p className="text-sm text-zinc-600">FastAPI 기반 REST API, MariaDB와 연동</p>
              </div>
              <div className="p-6 border rounded-lg bg-white shadow-sm hover:shadow-md transition">
                <h3 className="text-lg font-semibold text-emerald-700 mb-2">GPU Backend</h3>
                <p className="text-sm text-zinc-600">PyTorch + CUDA로 모델 학습 및 추론 담당</p>
              </div>
            </div>
          </div>
          ...
          {/* 미션 섹션 */}
          <div className="border-t border-zinc-200 pt-10 mb-16">
            <h2 className="text-2xl font-semibold mb-4 text-zinc-900">IPFORCE의 미션</h2>
          ...
          <div className="text-center border-t border-zinc-200 pt-12">
            <h2 className="text-2xl font-bold mb-4 text-zinc-900">IPFORCE와 함께 하세요</h2>
