    ...
    useEffect(() => {
        ...
        async function loadProject() {
            try {
                ...
                const resProject = await fetch(`${API_BASE}/api/project/${project_id}?source_type=${currentSubPath}`);
                const dataProject = await resProject.json();

                const requiredSubPath = dataProject.source_type.toLowerCase(); // 예: 'search'
