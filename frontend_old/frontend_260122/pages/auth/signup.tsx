...
import Link from 'next/link'; // 🚀 수정된 부분
                        ...
                        <form onSubmit={onSubmit} className="space-y-5">
                            <div className="space-y-2 text-left">
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-3.5 bg-zinc-50 border-none rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-medium text-zinc-900 shadow-inner"
                                    disabled={loading}
                                />
                            </div>
                            ...
                            <div className="space-y-2 text-left">
                                ...
                                <input
                                    ...
                                    className={`w-full px-6 py-3.5 bg-zinc-50 border-2 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-medium text-zinc-900 shadow-inner ${email.length > 0 && !emailOk ? 'border-red-100 bg-red-50/30' : 'border-transparent'}`}
                                    disabled={loading}
                                />
                            ...
                            <div className="space-y-2 text-left">
                                ...
                                <input
                                    ...
                                    className={`w-full px-6 py-3.5 bg-zinc-50 border-2 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-medium text-zinc-900 shadow-inner ${pw2.length > 0 && pw !== pw2 ? 'border-red-100 bg-red-50/30' : 'border-transparent'}`}
                                    disabled={loading}
                                />
                            </div>
